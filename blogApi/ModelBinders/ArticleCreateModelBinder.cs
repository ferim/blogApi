...
{
    public class ArticleCreateModelBinder : IModelBinder
    {
        //logger
        ...
        private static CreateArticleDto SetValuesForModel(ModelBindingContext bindingContext)
        {
            var dtoModel = new CreateArticleDto();
            var properties = typeof(CreateArticleDto).GetProperties();
